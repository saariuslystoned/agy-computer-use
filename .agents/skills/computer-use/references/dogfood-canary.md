...
- **Non-Production Warning**: The canary server is explicitly non-production. Full production acceptance requires native host dual-perception via `computer_use_observe` and `computer_use_ax_tree`.
