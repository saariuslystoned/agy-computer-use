...
- **Production Host**: Perception uses `computer_use_observe` and `computer_use_ax_tree`; shared-workstation semantic press uses `computer_use_ax_action`; global input tools require exclusive GUI control.
